...
export const SocialButtons = ({translation}: {translation: string}) => (
    <div className="mt-8">
      <div className="relative">
        ...
        <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-500">{translation}</span>
        </div>
      </div>
      <div className="mt-6 grid grid-cols-2 gap-3">
        <Button
          ...
          type="button"
          leftIcon={
            <svg className="w-5 h-5" aria-label="Google logo" viewBox="0 0 24 24">
        ...
        <Button
          ...
          type="button"
          leftIcon={
            <svg className="w-5 h-5" aria-label="Facebook logo" fill="#1877F2" viewBox="0 0 24 24">
