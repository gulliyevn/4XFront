                            ...
                            <div className="metric-card">
                                ...
                                <div className="metric-status">
                                    <div
                                        ...
                                        style={{
                                            backgroundColor: getStatusColor(100 - systemMetrics.apiResponseTime, {
                                                good: 50,
                                                warning: 30,
                                            }),
                                        }}></div>
                            ...
                            <div className="metric-card">
                                ...
                                <div className="metric-status">
                                    <div
                                        className="status-bar"
                                        style={{
                                            backgroundColor: getStatusColor(systemMetrics.dataProcessingSpeed, {
                                                good: 1.0,
                                                warning: 0.7,
                                            }),
                                        }}></div>
                            ...
                            <div className="metric-card">
                                ...
                                <div className="metric-status">
                                    <div
                                        className="status-bar"
                                        style={{
                                            backgroundColor: getStatusColor(systemMetrics.predictionAccuracy, {
                                                good: 90,
                                                warning: 80,
                                            }),
                                        }}></div>
                            ...
                            <div className="metric-card">
                                ...
                                <div className="metric-status">
                                    <div
                                        className="status-bar"
                                        style={{
                                            backgroundColor: getStatusColor(systemMetrics.systemUptime, {
                                                good: 99.5,
                                                warning: 99.0,
                                            }),
                                        }}></div>
