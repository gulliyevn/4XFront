    ...
    const mobileFeatures = [
        {
            ...
            description:
                'Execute trades instantly with our lightning-fast mobile interface. Get real-time quotes, charts, and market data wherever you are.',
            icon: '⚡',
            benefits: ['Instant order execution', 'Real-time price alerts', 'Advanced charting tools', 'One-tap trading'],
        },
        {
            id: 1,
            title: 'AI-Powered Insights',
            description:
                'Access our full suite of AI predictions and market analysis directly on your mobile device with the same accuracy as desktop.',
            icon: '🤖',
            benefits: ['94.7% prediction accuracy', 'Smart notifications', 'Personalized insights', 'Voice-activated commands'],
        },
        {
            id: 2,
            title: 'Biometric Security',
            description:
                'Advanced security features including Face ID, Touch ID, and encrypted data storage to keep your investments safe.',
            icon: '🔐',
            benefits: ['Face ID / Touch ID login', 'End-to-end encryption', 'Secure PIN backup', 'Device authentication'],
        },
        {
            id: 3,
            title: 'Offline Mode',
            description:
                "Continue monitoring your portfolio and accessing key features even when you're offline or have poor connectivity.",
            icon: '📱',
            benefits: ['Offline portfolio view', 'Cached market data', 'Sync when connected', 'Emergency trading mode'],
        },
    ]
                    ...
                    <div className="features-showcase">
                        ...
                        <div className="feature-content">
                            <div className="feature-details">
                                ...
                                <p className="feature-description">{mobileFeatures[activeFeature].description}</p>
